...
export type DemoPrincipal = "allowed-user" | "denied-user" | "cross-tenant-user" | "admin-user";
...
export interface UnansweredRecord { queryId: string; category: string; queryHash: string; createdAt: string; safeSummary: string; }
